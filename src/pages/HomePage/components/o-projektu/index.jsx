...
export const OProjektu = () => {
  return (
    <>
      <div style={{ backgroundImage: `url(${wedding})` }} className="project">
        ...
        <p className="project__description">
          ...
          svatby a podle tohoto údaje se body na časové ose přerendrují např. na
          konkrétní měsíce. Když uživatel klikne na konkrétní časový bod
          ...
          usnadnění plánování svatby. Náš web uživatele provede plánováním krok
          po kroku se všemi důležitými informacemi na jednom místě.{' '}
        </p>
      </div>
    </>
  );
